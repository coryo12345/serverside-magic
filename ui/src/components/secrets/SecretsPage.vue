    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      >
        <div class="flex items-center gap-3">
          <div class="w-9 h-9 rounded-full bg-purple-900/60 border border-purple-500/40 flex items-center justify-center shrink-0">
        ...
        <p class="text-surface-300 dark:text-surface-400 text-sm leading-relaxed">
          {{ secret.description }}
        </p>
      </div>
    </div>
